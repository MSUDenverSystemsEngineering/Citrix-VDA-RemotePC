...
Try {
	...
	[string]$appName = 'VDA RemotePC'
	[string]$appVersion = '1912'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'ctxsvchost' -CheckDiskSpace -PersistPrompt
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'CtxSvcHost' -CloseAppsCountdown 60
